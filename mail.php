...
try {
  ...
  $mail->Username   = 'anastasiasuliaeva@yandex.ru'; // Логин на почте
  $mail->Password   = 'cyqvgjbixvgidulb'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('anastasiasuliaeva@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('anastasiasuliaeva@yandex.ru');
